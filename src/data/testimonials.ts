...
export const testimonials: Testimonial[] = [
  { id: "t1", name: "Sarah & Michael Thompson", role: "Honeymooners", location: "London, UK", rating: 5, avatar: IMG.p2,
    quote: "From the first email to the last sundowner, every detail was flawless. The Mara exceeded our wildest dreams and the Diani finale was pure bliss. Success Tours made our honeymoon perfect." },
  ...
  { id: "t8", name: "Kwame & Ama Osei", role: "Anniversary Trip", location: "Accra, Ghana", rating: 5, avatar: IMG.p8,
    quote: "For our 25th anniversary we wanted something special, and Success Tours delivered beyond measure. The balloon safari at dawn brought tears to our eyes." },
];
