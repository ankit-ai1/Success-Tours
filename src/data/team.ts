...
export const team: TeamMember[] = [
  { id: "tm1", name: "Joseph Mwangi", role: "Founder & Managing Director", image: IMG.p1,
    bio: "A third-generation Kenyan and lifelong conservationist, Joseph founded Success Tours in 2008 to share the Kenya he loves while protecting it for the future." },
  ...
  { id: "tm6", name: "Faith Njeri", role: "Sustainability Lead", image: IMG.p5,
    bio: "Faith oversees our conservation partnerships and community programmes, ensuring every journey gives back to Kenya's people and wildlife." },
];
