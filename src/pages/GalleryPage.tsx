...
export default function GalleryPage() {
  ...
  return (
    <Page>
      <SEO
        title="Photo Gallery"
        description="A visual journey through Kenya with Success Tours — wildlife, landscapes, beaches, lodges and culture captured across our safaris and tours."
        path="/gallery"
      />
      <PageHero
        eyebrow="In pictures"
        title="Gallery"
        subtitle="Real moments from across our journeys — the wildlife, the landscapes and the magic of Kenya."
        image={IMG.elephants}
