...
export default function ContactPage() {
  ...
  const details = [
    { icon: MapPin, label: "Visit us", value: company.address, sub: company.poBox },
    { icon: Phone, label: "Call us", value: company.phone, sub: company.phoneAlt, href: `tel:${company.phone.replace(/\s/g, "")}` },
    { icon: Mail, label: "Email us", value: company.email, sub: company.salesEmail, href: `mailto:${company.email}` },
  ...
  return (
    <Page>
      <SEO
        title="Contact Us"
        description="Get in touch with Success Tours & Travel Kenya. Call, email, WhatsApp or visit our Nairobi office — our travel specialists are ready to plan your perfect Kenyan journey."
        path="/contact"
