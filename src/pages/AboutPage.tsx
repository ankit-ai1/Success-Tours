...
export default function AboutPage() {
  return (
    <Page>
      <SEO
        title="About Us"
        description="Meet Success Tours & Travel Kenya — a team of Kenyan travel specialists crafting bespoke, responsible safaris since 2008. Discover our story, mission, values and people."
        path="/about"
        structuredData={organizationSchema}
      />
      <PageHero
        eyebrow="Our story"
        title="About Success Tours"
        subtitle="Kenyan-born, traveller-obsessed and conservation-minded — crafting journeys that change how you see the world since 2008."
        ...
        <Container>
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            ...
            <Reveal delay={0.1}>
              ...
              <h2 className="font-display text-3xl font-bold text-primary sm:text-4xl">A passion for Kenya, shared with the world</h2>
              <div className="mt-5 space-y-4 text-base leading-relaxed text-muted">
                <p>
                  Success Tours & Travel Kenya was founded in {company.founded} by a small team of Nairobi-based
                  guides with one conviction: that a Kenyan safari, done right, can change a life — both the
                ...
                <p>
                  ...
                  globe, yet we've never lost our founding spirit. Every itinerary is still designed by hand, every
                  guide hand-picked, and every journey built to give back to the wildlife and people of Kenya.
                </p>
                <p>
