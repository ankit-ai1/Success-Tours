  ...
  return (
    <Page>
      <SEO
        ...
        description="Answers to common questions about travelling to Kenya with Success Tours — visas, health, safety, best times to visit, booking, packing and more."
        path="/faq"
        structuredData={{
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="mt-12 rounded-xl border border-sand-200 bg-sand p-8 text-center">
              ...
              <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row">
                ...
                <Link to="/quote" className="text-sm font-semibold text-secondary hover:text-secondary-dark">or request a free quote →</Link>
              </div>
            </div>
          </div>
        </Container>
