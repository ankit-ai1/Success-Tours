...
export default function DestinationDetailsPage() {
  ...
  const related = getPackagesBySlugs(destination.relatedPackages);
  const others = destinations.filter((d) => d.id !== destination.id).slice(0, 4);
            ...
            <aside className="lg:col-span-1">
              <div className="sticky top-24 space-y-5">
                <div className="rounded-lg border border-sand-200 bg-sand p-6 shadow-soft">
                  ...
                  <Button to="/quote" variant="secondary" size="md" fullWidth className="mt-6">
                    Plan a trip here
                  </Button>
                </div>
        ...
        <section className="bg-sand py-20 lg:py-28">
          <Container>
            <div className="flex flex-wrap items-end justify-between gap-4">
              <SectionHeading eyebrow="Recommended journeys" title={`Packages featuring ${destination.name}`} />
