...
const perks = [
  ...
  { icon: ThumbsUp, title: "Expert guidance", text: "Honest advice from Kenya-based specialists." },
];
  ...
  return (
    <Page>
      <SEO
        ...
        description="Tell us about your dream Kenyan trip and receive a free, tailor-made proposal within 24 hours. No obligation — just expert planning from Success Tours & Travel Kenya."
        path="/quote"
      />
      <PageHero
