        ...
        <div className="lg:col-span-2">
          <Link to="/" className="mb-4 flex items-center gap-2">
            ...
            <span className="flex flex-col leading-none">
              <span className="font-display text-lg font-bold text-white">Success Tours</span>
              <span className="text-[10px] font-semibold uppercase tracking-[0.18em] text-accent">& Travel Kenya</span>
            </span>
          </Link>
          <p className="max-w-sm text-sm leading-relaxed text-white/60">
            Bespoke Kenyan safaris, beach escapes and cultural journeys crafted with care since {company.founded}. Travel that delights you and protects Kenya.
          </p>
      ...
      <div className="border-t border-white/10">
        <div className="container-max flex flex-col items-center justify-between gap-3 py-5 text-xs text-white/50 sm:flex-row">
          ...
          <p className="flex flex-wrap items-center gap-1">
            Popular: {destinations.slice(0, 4).map((d, i) => (
              <span key={d.id}>
